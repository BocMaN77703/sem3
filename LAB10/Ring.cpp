...
void Ring<T>::findByValue()
{
	...
	cout << "Введите параметры поиска." << endl;
	system("pause");
	object.changeInf();
	...
	{
		cout << "Элементов с заданным параметром в списке не найдено!" << endl;
	}
...
void Ring<T>::editElement()
{
	...
	do
	{
		cout << "Введите номер элемента, у которого хотите изменить данные: ";
		cin >> choice;
